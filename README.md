...
### Benchmark
Here's a side-by-side comparison of the scoring distribution generated by the trained model vs. the base model. It performs better than the base model in matching songs with moods.
